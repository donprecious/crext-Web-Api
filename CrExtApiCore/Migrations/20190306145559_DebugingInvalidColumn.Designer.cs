...
namespace CrExtApiCore.Migrations
{
    ...
    [Migration("20190306145559_DebugingInvalidColumn")]
    partial class DebugingInvalidColumn
    {
            ...
            modelBuilder.Entity("Entities.Projects", b =>
                {
                    ...
                    b.Property<int?>("ReviewNotificationsId");

                    b.HasKey("Id");

                    b.HasIndex("OrganisationId");

                    b.HasIndex("ReviewNotificationsId");
            ...
            modelBuilder.Entity("Entities.Projects", b =>
                {
                    ...
                    b.HasOne("Entities.ReviewNotifications", "ReviewNotifications")
                        .WithMany()
                        .HasForeignKey("ReviewNotificationsId");
                });
