...
namespace CrExtApiCore.Migrations
{
    ...
    [Migration("20190121144455_updatePackageRole")]
    partial class updatePackageRole
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Entities.Organisations", b =>
                {
                    ...
                    b.Property<string>("Nature_of_Business");
            ...
            modelBuilder.Entity("Entities.PackageRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<int?>("PackagesRolesId");

                    b.HasKey("Id");

                    b.HasIndex("PackageIdId");

                    b.HasIndex("PackagesRolesId");

                    b.ToTable("PackageRoles");
                });
            ...
            modelBuilder.Entity("Entities.Packages", b =>
                {
                    ...
                    b.Property<int?>("PackageRoleId");

                    b.Property<int?>("PackagesRolesId");

                    b.HasKey("Id");

                    b.HasIndex("PackageRoleId");
            ...
            modelBuilder.Entity("Entities.PackagesRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("PackageRoleId");
            ...
            modelBuilder.Entity("Entities.PackageRole", b =>
                {
                    b.HasOne("Entities.Packages", "PackageId")
                        .WithMany()
                        .HasForeignKey("PackageIdId");

                    b.HasOne("Entities.PackagesRoles")
                        .WithMany("PackageRole")
                        .HasForeignKey("PackagesRolesId");
                });

            modelBuilder.Entity("Entities.Packages", b =>
                {
                    b.HasOne("Entities.PackageRole")
                        .WithMany("Packages")
                        .HasForeignKey("PackageRoleId");
            ...
            modelBuilder.Entity("Entities.PackagesRoles", b =>
                {
                    b.HasOne("Entities.Packages")
                        .WithMany("PackagesRoles")
