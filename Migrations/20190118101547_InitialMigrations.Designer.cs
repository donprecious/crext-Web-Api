...
namespace CrExtApiCore.Migrations
{
    ...
    [Migration("20190118101547_InitialMigrations")]
    partial class InitialMigrations
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Entities.PackageRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Entities.Packages", b =>
                {
                    ...
                    b.Property<int?>("PackageRolesId");

                    b.HasKey("Id");

                    b.HasIndex("PackageRolesId");
            ...
            modelBuilder.Entity("Entities.Packages", b =>
                {
                    b.HasOne("Entities.PackageRoles")
                        .WithMany("package")
                        .HasForeignKey("PackageRolesId");
                });
